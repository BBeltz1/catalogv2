...
NARW Abundance 1) Year 2) lower95 = lower 95% confidence interval value in number of animals.  3) Median=median estimate of right whale abundance in number of animals.  4) Upper95= upper 95% confidence interval value in number of animals.   5) Mean= mean estimate of right whale abundance in number of animals.   6) SD=standard deviation of estimate of right whale abundance in number of animals.  
