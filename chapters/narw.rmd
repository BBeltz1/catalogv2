...
The North Atlantic right whale population was on a recovery trajectory until 2010, but has since declined.
...
North Atlantic right whale calf counts have generally declined after 2009 to the point of having zero new calves observed in 2018.
...
# Plot indicator
ggplotObject <- ecodata::plot_narw(report= 'MidAtlantic', varName= 'adult',n=10)
ggplotObject
```

```{r plot_narwMidAtlanticcalf}
# Plot indicator
ggplotObject <- ecodata::plot_narw(report= 'MidAtlantic', varName= 'calf',n=10)
ggplotObject
```
...
# Plot indicator
ggplotObject <- ecodata::plot_narw(report= 'NewEngland', varName= 'adult',n=10)
ggplotObject
```

```{r plot_narwNewEnglandcalf}
# Plot indicator
ggplotObject <- ecodata::plot_narw(report= 'NewEngland', varName= 'calf',n=10)
ggplotObject
```
...
NARW Abundance 1) Year 2) lower95 = lower 95% confidence interval value in number of animals.  
...
6) SD=standard deviation of estimate of right whale abundance in number of animals.  NARW Calves 
1) Year 2) Tot.Calves = total number of right whale calves born that year in number of animals.
