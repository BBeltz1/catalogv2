...
try(downloadthis::download_this(
ggplotObject$data,
output_name = 'graysealNewEngland',
output_extension = '.csv',
button_label = 'Download the data plotted above',
button_type = 'default',
has_icon = TRUE,
...
1) pbr = Potential Biological Removal level. Unit = n (number of animals) 2) totalest1y = Total bycatch of 1 year annual estimate. Unit = n (number of animals) 3) totalest5y = Total bycatch of 5 year running average estimate. Unit = n (number of animals) 
4) total5yLCI = Lower 95% confidence interval of totalest5y. Unit = n (number of animals) 5) total5yUCI= Upper 95% confidence interval of totalest5y. Unit = n (number of animals)
