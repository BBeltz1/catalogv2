...
Line plot:  1) By species-year-season: 
2) Mean Energy Density (kJ/g)  Bubble Plot:  
1) By species-year-season-EPU: 
2) Mean energy density (ED; kJ/g wet weight) 
3) Mean catch per (representative) tow (kg) 
