...
Line plot: By species-year-season: Mean Energy Density (kJ/g)  Bubble Plot: 
By species-year-season-EPU: Mean energy density (ED; kJ/g wet weight) 
Mean catch per (representative) tow (kg) 
Ecological production unit (EPU): Mid-Atlantic Bight (MAB), Georges Bank (GB), Gulf of Maine (GOM), and Scotian Shelf (SS)
