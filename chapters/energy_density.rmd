...
```{r download_energy_density}
# Download dataset from ecodata
downloadthis::download_this(
ecodata::energy_density,
output_name = 'energy_density',
...
ggplotObject$data,
output_name = 'energy_densityMidAtlantic',
output_extension = '.csv',
...
Line plot:  1) By species-year-season: 2) Mean Energy Density (kJ/g)  Bubble Plot:  1) By species-year-season-EPU: 2) Mean energy density (ED; kJ/g wet weight) 3) Mean catch per (representative) tow (kg) 4) Ecological production unit (EPU): Mid-Atlantic Bight (MAB), Georges Bank (GB), Gulf of Maine (GOM), and Scotian Shelf (SS)
