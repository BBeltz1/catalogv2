...
try(downloadthis::download_this(
ggplotObject$data,
output_name = 'gom_salmonNewEngland',
output_extension = '.csv',
button_label = 'Download the data plotted above',
button_type = 'default',
has_icon = TRUE,
...
1) Name: Number of Salmon Definition: Trap Counts or Redd-Based Estimate of Adult returns 2) Name: Percent Return Rate Definition: Total Adult Hatchery Return to Penobscot River divided by Estimated Post-Smolts entering ocean 2 years earlier
