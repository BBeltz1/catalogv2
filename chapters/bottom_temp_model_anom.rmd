...
**Contributor(s)**: Joseph Caracappa, Hubert du Pontavice, Vincent Saba, Zhuomin Chen, Laura Gruenburg, Andrew Ross
...
**MOM6**
Here we show the seasonal temperature anomalies in the Mid Atlantic Bight (MAB), Georges Bank (GB) and Gulf of Maine (GOM) EPUs. Data from 1959 through 1992 are from the biased corrected ROMS dataset (Pontavice et al., 2022). Data from 1993 through 2019 are from MOM6 (Ross et al., 2023), and 1993 through 2023 are from GLORYS12 reanalysis (Lellouche et al., 2021). For the anomaly plots the climatology period is 1990 through 2020.
...
```{r plot_bottom_temp_model_anomMidAtlanticseasonalGLORYSMAB}
# Plot indicator
ggplotObject <- ecodata::plot_bottom_temp_model_anom(report= 'MidAtlantic', EPU = 'MAB', varName= 'seasonal', plottype = 'GLORYS',n=10)
ggplotObject
```


```{r plot_bottom_temp_model_anomMidAtlanticseasonalMOM6MAB}
# Plot indicator
ggplotObject <- ecodata::plot_bottom_temp_model_anom(report= 'MidAtlantic', EPU = 'MAB', varName= 'seasonal', plottype = 'MOM6',n=10)
ggplotObject
```


```{r plot_bottom_temp_model_anomMidAtlanticannualGLORYSMAB}
# Plot indicator
ggplotObject <- ecodata::plot_bottom_temp_model_anom(report= 'MidAtlantic', EPU = 'MAB', varName= 'annual', plottype = 'GLORYS',n=10)
ggplotObject
```


```{r plot_bottom_temp_model_anomMidAtlanticannualMOM6MAB}
# Plot indicator
ggplotObject <- ecodata::plot_bottom_temp_model_anom(report= 'MidAtlantic', EPU = 'MAB', varName= 'annual', plottype = 'MOM6',n=10)
ggplotObject
```
...
```{r plot_bottom_temp_model_anomNewEnglandseasonalGLORYSGB}
# Plot indicator
ggplotObject <- ecodata::plot_bottom_temp_model_anom(report= 'NewEngland', EPU = 'GB', varName= 'seasonal', plottype = 'GLORYS',n=10)
ggplotObject
```

```{r plot_bottom_temp_model_anomNewEnglandseasonalGLORYSGOM}
# Plot indicator
ggplotObject <- ecodata::plot_bottom_temp_model_anom(report= 'NewEngland', EPU = 'GOM', varName= 'seasonal', plottype = 'GLORYS',n=10)
ggplotObject
```


```{r plot_bottom_temp_model_anomNewEnglandseasonalMOM6GB}
# Plot indicator
ggplotObject <- ecodata::plot_bottom_temp_model_anom(report= 'NewEngland', EPU = 'GB', varName= 'seasonal', plottype = 'MOM6',n=10)
ggplotObject
```

```{r plot_bottom_temp_model_anomNewEnglandseasonalMOM6GOM}
# Plot indicator
ggplotObject <- ecodata::plot_bottom_temp_model_anom(report= 'NewEngland', EPU = 'GOM', varName= 'seasonal', plottype = 'MOM6',n=10)
ggplotObject
```


```{r plot_bottom_temp_model_anomNewEnglandannualGLORYSGB}
# Plot indicator
ggplotObject <- ecodata::plot_bottom_temp_model_anom(report= 'NewEngland', EPU = 'GB', varName= 'annual', plottype = 'GLORYS',n=10)
ggplotObject
```

```{r plot_bottom_temp_model_anomNewEnglandannualGLORYSGOM}
# Plot indicator
ggplotObject <- ecodata::plot_bottom_temp_model_anom(report= 'NewEngland', EPU = 'GOM', varName= 'annual', plottype = 'GLORYS',n=10)
ggplotObject
```


```{r plot_bottom_temp_model_anomNewEnglandannualMOM6GB}
# Plot indicator
ggplotObject <- ecodata::plot_bottom_temp_model_anom(report= 'NewEngland', EPU = 'GB', varName= 'annual', plottype = 'MOM6',n=10)
ggplotObject
```

```{r plot_bottom_temp_model_anomNewEnglandannualMOM6GOM}
# Plot indicator
ggplotObject <- ecodata::plot_bottom_temp_model_anom(report= 'NewEngland', EPU = 'GOM', varName= 'annual', plottype = 'MOM6',n=10)
ggplotObject
```
...
**Point of contact**: [joseph.caracappa@noaa.gov; laura.gruenburg@noaa.gov](mailto:joseph.caracappa@noaa.gov; laura.gruenburg@noaa.gov){.email}
