...
![Weekly mean sea surface temperature (October 8-10, 2023) with the long-term mean Gulf Stream position (dark line). Red lines represent the 26oC (78.8 oF) temperature contour.](https://github.com/NOAA-EDAB/ecodata/raw/master/workshop/images/2023-GS-October-internalreview.png){width=100%}
...
![The number of days in 2022 where bottom temperature was between 17 and 19 ℃ (stressful thermal temperatures for sea scallops) in each GLORYS grid cell. The gray lines show the sea scallop estimation areas, with the Elephant Trunk region highlighted in black lines.](https://github.com/NOAA-EDAB/ecodata/raw/master/workshop/images/bottom_temp_threshold_17_19_Elephant_Trunk.png){width=100%}
