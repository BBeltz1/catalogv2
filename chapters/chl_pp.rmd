...
# Plot indicator
ggplotObject <- ecodata::plot_chl_pp(report= 'MidAtlantic', varName= 'chl' ,plottype= 'weekly',n=10)
ggplotObject
```

```{r plot_chl_ppMidAtlanticchlmonthly}
# Plot indicator
ggplotObject <- ecodata::plot_chl_pp(report= 'MidAtlantic', varName= 'chl' ,plottype= 'monthly',n=10)
ggplotObject
```

```{r plot_chl_ppMidAtlanticchlanomaly}
# Plot indicator
ggplotObject <- ecodata::plot_chl_pp(report= 'MidAtlantic', varName= 'chl' ,plottype= 'anomaly',n=10)
ggplotObject
```

```{r plot_chl_ppMidAtlanticppweekly}
# Plot indicator
ggplotObject <- ecodata::plot_chl_pp(report= 'MidAtlantic', varName= 'pp' ,plottype= 'weekly',n=10)
ggplotObject
```

```{r plot_chl_ppMidAtlanticppmonthly}
# Plot indicator
ggplotObject <- ecodata::plot_chl_pp(report= 'MidAtlantic', varName= 'pp' ,plottype= 'monthly',n=10)
ggplotObject
```

```{r plot_chl_ppMidAtlanticppanomaly}
# Plot indicator
ggplotObject <- ecodata::plot_chl_pp(report= 'MidAtlantic', varName= 'pp' ,plottype= 'anomaly',n=10)
ggplotObject
```
...
# Plot indicator
ggplotObject <- ecodata::plot_chl_pp(report= 'NewEngland', varName= 'chl' ,plottype= 'weekly',n=10)
ggplotObject
```

```{r plot_chl_ppNewEnglandchlmonthly}
# Plot indicator
ggplotObject <- ecodata::plot_chl_pp(report= 'NewEngland', varName= 'chl' ,plottype= 'monthly',n=10)
ggplotObject
```

```{r plot_chl_ppNewEnglandchlanomaly}
# Plot indicator
ggplotObject <- ecodata::plot_chl_pp(report= 'NewEngland', varName= 'chl' ,plottype= 'anomaly',n=10)
ggplotObject
```

```{r plot_chl_ppNewEnglandppweekly}
# Plot indicator
ggplotObject <- ecodata::plot_chl_pp(report= 'NewEngland', varName= 'pp' ,plottype= 'weekly',n=10)
ggplotObject
```

```{r plot_chl_ppNewEnglandppmonthly}
# Plot indicator
ggplotObject <- ecodata::plot_chl_pp(report= 'NewEngland', varName= 'pp' ,plottype= 'monthly',n=10)
ggplotObject
```

```{r plot_chl_ppNewEnglandppanomaly}
# Plot indicator
ggplotObject <- ecodata::plot_chl_pp(report= 'NewEngland', varName= 'pp' ,plottype= 'anomaly',n=10)
ggplotObject
```
