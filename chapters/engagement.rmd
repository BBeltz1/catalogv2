...
```{r plot_engagementMidAtlanticCommercialplot}
# Plot indicator
ggplotObject <- ecodata::plot_engagement(report= 'MidAtlantic', varName= 'Commercial' ,plottype= 'plot')
ggplotObject
```

```{r plot_engagementMidAtlanticCommercialSocial}
# Plot indicator
ggplotObject <- ecodata::plot_engagement(report= 'MidAtlantic', varName= 'Commercial' ,plottype= 'Social')
ggplotObject
```
...
```{r plot_engagementMidAtlanticRecreationalplot}
# Plot indicator
ggplotObject <- ecodata::plot_engagement(report= 'MidAtlantic', varName= 'Recreational' ,plottype= 'plot')
ggplotObject
```

```{r plot_engagementMidAtlanticRecreationalSocial}
# Plot indicator
ggplotObject <- ecodata::plot_engagement(report= 'MidAtlantic', varName= 'Recreational' ,plottype= 'Social')
ggplotObject
```
...
```{r plot_engagementNewEnglandCommercialplot}
# Plot indicator
ggplotObject <- ecodata::plot_engagement(report= 'NewEngland', varName= 'Commercial' ,plottype= 'plot')
ggplotObject
```

```{r plot_engagementNewEnglandCommercialSocial}
# Plot indicator
ggplotObject <- ecodata::plot_engagement(report= 'NewEngland', varName= 'Commercial' ,plottype= 'Social')
ggplotObject
```
...
```{r plot_engagementNewEnglandRecreationalplot}
# Plot indicator
ggplotObject <- ecodata::plot_engagement(report= 'NewEngland', varName= 'Recreational' ,plottype= 'plot')
ggplotObject
```

```{r plot_engagementNewEnglandRecreationalSocial}
# Plot indicator
ggplotObject <- ecodata::plot_engagement(report= 'NewEngland', varName= 'Recreational' ,plottype= 'Social')
ggplotObject
```
