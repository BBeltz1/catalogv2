...
*Landings*  1) Name: Landings; Definition: Total landings for a region; Units: metric tons.  2) Name: Seafood Landings; Definition: Total landings used for human consumption for a region; Units: metric tons. 
 ...
 *Revenue*  1) Name: Revenue; Definition: Total revenue for a region; Units: US dollars. 2) Name: Guild Revenue; Definition: Total revenue for an aggregate group within a region. Guilds include Benthivore, Benthos, Other, Piscivore, and Planktivore. For example "Benthivore Revenue"; Units: US dollars 
