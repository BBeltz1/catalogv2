...
```{r plot_benthos_indexMidAtlanticMicrobenthosindex}
# Plot indicator
ggplotObject <- ecodata::plot_benthos_index(report= 'MidAtlantic', varName= 'Microbenthos' ,plottype= 'index',n=10)
ggplotObject
```

```{r plot_benthos_indexMidAtlanticMicrobenthoscog}
# Plot indicator
ggplotObject <- ecodata::plot_benthos_index(report= 'MidAtlantic', varName= 'Microbenthos' ,plottype= 'cog',n=10)
ggplotObject
```
...
```{r plot_benthos_indexNewEnglandMicrobenthosindex}
# Plot indicator
ggplotObject <- ecodata::plot_benthos_index(report= 'NewEngland', varName= 'Microbenthos' ,plottype= 'index',n=10)
ggplotObject
```

```{r plot_benthos_indexNewEnglandMicrobenthoscog}
# Plot indicator
ggplotObject <- ecodata::plot_benthos_index(report= 'NewEngland', varName= 'Microbenthos' ,plottype= 'cog',n=10)
ggplotObject
```
