...
# Plot indicator
ggplotObject <- ecodata::plot_wind_revenue(report= 'MidAtlantic', varName= 'landing' ,plottype= 'facets',n=10)
ggplotObject
```

```{r plot_wind_revenueMidAtlanticlandingnofacets}
# Plot indicator
ggplotObject <- ecodata::plot_wind_revenue(report= 'MidAtlantic', varName= 'landing' ,plottype= 'nofacets',n=10)
ggplotObject
```

```{r plot_wind_revenueMidAtlanticvaluefacets}
# Plot indicator
ggplotObject <- ecodata::plot_wind_revenue(report= 'MidAtlantic', varName= 'value' ,plottype= 'facets',n=10)
ggplotObject
```

```{r plot_wind_revenueMidAtlanticvaluenofacets}
# Plot indicator
ggplotObject <- ecodata::plot_wind_revenue(report= 'MidAtlantic', varName= 'value' ,plottype= 'nofacets',n=10)
ggplotObject
```
...
# Plot indicator
ggplotObject <- ecodata::plot_wind_revenue(report= 'NewEngland', varName= 'landing' ,plottype= 'facets',n=10)
ggplotObject
```

```{r plot_wind_revenueNewEnglandlandingnofacets}
# Plot indicator
ggplotObject <- ecodata::plot_wind_revenue(report= 'NewEngland', varName= 'landing' ,plottype= 'nofacets',n=10)
ggplotObject
```

```{r plot_wind_revenueNewEnglandvaluefacets}
# Plot indicator
ggplotObject <- ecodata::plot_wind_revenue(report= 'NewEngland', varName= 'value' ,plottype= 'facets',n=10)
ggplotObject
```

```{r plot_wind_revenueNewEnglandvaluenofacets}
# Plot indicator
ggplotObject <- ecodata::plot_wind_revenue(report= 'NewEngland', varName= 'value' ,plottype= 'nofacets',n=10)
ggplotObject
```
