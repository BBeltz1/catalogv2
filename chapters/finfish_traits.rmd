...
**Point of contact**: [Bart DiFiore (bdifiore@gmri.org)](mailto:Bart DiFiore (bdifiore@gmri.org)){.email}
...
- trophic_level: Trophic level - offspring_size: Average estimated size of offspring (mm) 
