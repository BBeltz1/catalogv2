...
```{r download_ches_bay_sst}
# Download dataset from ecodata
downloadthis::download_this(
ecodata::ches_bay_sst,
output_name = 'ches_bay_sst',
...
ggplotObject$data,
output_name = 'ches_bay_sstMidAtlantic',
output_extension = '.csv',
...
try(downloadthis::download_this(
ggplotObject$data,
output_name = 'ches_bay_sstNewEngland',
output_extension = '.csv',
button_label = 'Download the data plotted above',
button_type = 'default',
has_icon = TRUE,
...
1) sst: sea surface temperature 2025, Celsius  2) sst_climatol: sea surface temperature climatology 2007-2024, Celsius  3) sst_anomaly: sea surface temperature anomaly 2025 minus 2007-2024, Celsius
