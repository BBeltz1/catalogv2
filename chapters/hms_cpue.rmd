...
Each column provides CPUE per species or management group as total # fish caught / total # hauls. This includes Large Coastal Shark CPUE, Small Coastal Shark CPUE, Pelagic Shark CPUE, Prohibited Shark CPUE, Blue Marlin (BUM) CPUE, Swordfish (SWO) CPUE, White Marlin (WHM) CPUE, Sailfish (SAI) CPUE, Albacore Tuna (ALB) CPUE, Skipjack Tuna (SKJ) CPUE, Bigeye Tuna (BET) CPUE, Bluefin Tuna (BFT) CPUE, and Yellowfin Tuna (YFT) CPUE.
