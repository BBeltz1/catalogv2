...
Year = estimates of shark landings are calculated on a yearly basis. Data Columns = MRIP and LPS landings data (# sharks x 1000) are summarized by region.  Large Coastal = summed MRIP estimates of annual landings of large coastal sharks, which include blacktip, bull, hammerheads (scalloped, great, and smooth), lemon, nurse, sandbar, silky, spinner, and tiger sharks. 
