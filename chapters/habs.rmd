...
5) Name: Gulf_of Maine_All; Definition: Estimated total numbers of cells (x10 to the 16th power) in entire Gulf of Maine; Units: Decimal number.  PSP: 1) Year; Definition: calendar year; Units: yyyy. 
2) Name: State; Definition: MA, NH, or ME ; Units: categories. 3) Name: N_Rows; Definition: Number of sample events represented; Units: integer.  
