...
1. pbr = Potential Biological Removal level. Unit = n (number of animals) 2. totalest1y = Total bycatch estimate over all gear types per year 3. totalest5y = Total bycatch estimate over all gear types as a 5-year running average 4. total5yLCI = Lower 95% confidence interval of totalest5y. Unit = n (number of animals) 
