...
# Plot indicator
ggplotObject <- ecodata::plot_commercial_div(report= 'MidAtlantic', varName= 'Fleet count',n=10)
ggplotObject
```

```{r plot_commercial_divMidAtlanticFleetdiversityinrevenue}
# Plot indicator
ggplotObject <- ecodata::plot_commercial_div(report= 'MidAtlantic', varName= 'Fleet diversity in revenue',n=10)
ggplotObject
```

```{r plot_commercial_divMidAtlanticPermitrevenuespeciesdiversity}
# Plot indicator
ggplotObject <- ecodata::plot_commercial_div(report= 'MidAtlantic', varName= 'Permit revenue species diversity',n=10)
ggplotObject
```
...
# Plot indicator
ggplotObject <- ecodata::plot_commercial_div(report= 'NewEngland', varName= 'Fleet count',n=10)
ggplotObject
```

```{r plot_commercial_divNewEnglandFleetdiversityinrevenue}
# Plot indicator
ggplotObject <- ecodata::plot_commercial_div(report= 'NewEngland', varName= 'Fleet diversity in revenue',n=10)
ggplotObject
```

```{r plot_commercial_divNewEnglandPermitrevenuespeciesdiversity}
# Plot indicator
ggplotObject <- ecodata::plot_commercial_div(report= 'NewEngland', varName= 'Permit revenue species diversity',n=10)
ggplotObject
```
