...
try(downloadthis::download_this(
ggplotObject$data,
output_name = 'habitat_diversityRichnessMidAtlantic',
output_extension = '.csv',
...
try(downloadthis::download_this(
ggplotObject$data,
output_name = 'habitat_diversityRichnessNewEngland',
output_extension = '.csv',
button_label = 'Download the data plotted above',
button_type = 'default',
has_icon = TRUE,
