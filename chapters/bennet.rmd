...
try(downloadthis::download_this(
ggplotObject$data,
output_name = 'bennetMidAtlanticguildMAB',
output_extension = '.csv',
...
try(downloadthis::download_this(
ggplotObject$data,
output_name = 'bennetMidAtlantictotalMAB',
output_extension = '.csv',
button_label = 'Download the data plotted above',
button_type = 'default',
has_icon = TRUE,
...
**total_guild, Mid-Atlantic Bight**
...
try(downloadthis::download_this(
ggplotObject$data,
output_name = 'bennetMidAtlantictotal_guildMAB',
output_extension = '.csv',
button_label = 'Download the data plotted above',
button_type = 'default',
has_icon = TRUE,
...
try(downloadthis::download_this(
ggplotObject$data,
output_name = 'bennetNewEnglandguildGB',
output_extension = '.csv',
button_label = 'Download the data plotted above',
button_type = 'default',
has_icon = TRUE,
...
try(downloadthis::download_this(
ggplotObject$data,
output_name = 'bennetNewEnglandtotalGB',
output_extension = '.csv',
button_label = 'Download the data plotted above',
button_type = 'default',
has_icon = TRUE,
...
try(downloadthis::download_this(
ggplotObject$data,
output_name = 'bennetNewEnglandtotal_guildGB',
output_extension = '.csv',
button_label = 'Download the data plotted above',
button_type = 'default',
has_icon = TRUE,
...
try(downloadthis::download_this(
ggplotObject$data,
output_name = 'bennetNewEnglandguildGOM',
output_extension = '.csv',
button_label = 'Download the data plotted above',
button_type = 'default',
has_icon = TRUE,
...
try(downloadthis::download_this(
ggplotObject$data,
output_name = 'bennetNewEnglandtotalGOM',
output_extension = '.csv',
button_label = 'Download the data plotted above',
button_type = 'default',
has_icon = TRUE,
...
try(downloadthis::download_this(
ggplotObject$data,
output_name = 'bennetNewEnglandtotal_guildGOM',
output_extension = '.csv',
button_label = 'Download the data plotted above',
button_type = 'default',
has_icon = TRUE,
...
## Implications
In the first 20 years of the series, this was due to declining volumes, while in the later part of the series it was due to both declining volumes and prices compared to 1982. In terms of volumes, the positive gains in the Benthos category was offset by declines in the Benthivore category. This reflects a shift to an EPU whose value is being generated from shellfish rather than finfish. 
...
For the Gulf of Maine and Georges Bank region, the decomposed VI shows that these two regions are becoming more reliant on shellfish for their landings, which likely increases risk for revenue losses if these volumes can’t be sustained. The overall BI for Gorges Bank was negative for all years in the time series, which is troubling because it shows that except for two years this particular EPU never achieved the same level of performance in terms of revenue as in 1982.  
...
**Point of contact**: John Walden (john.walden@noaa.gov); Geret DePiper (geret.depiper@noaa.gov)

**ecodata dataset**: `ecodata::bennet`

**Tech Doc link**: <https://noaa-edab.github.io/tech-doc/bennet.html>
